...
class ClickToMoveHandler:
    ...
    def handle_mouse_motion(
        ...
        if tile_pos:
            ...
            if (valid_moves and tile_pos in valid_moves and 
                current_position and self.pathfinder):
    ...
    def handle_tile_click(
        ...
        if entity_at_tile:
            ...
            if hasattr(entity_at_tile, 'faction'):
                ...
                elif entity_at_tile.faction in ["neutral", "friendly"] and self.on_interact_npc:
