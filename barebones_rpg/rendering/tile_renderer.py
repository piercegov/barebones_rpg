...
class TileRenderer:
    ...
    def render_entity_hp_bar(
        ...
        self.renderer.draw_rect(
            bar_x, bar_y,
            int(bar_width * hp_percent), bar_height,
            hp_color,
            filled=True
        )
    ...
    def render_location(
        ...
        if valid_moves:
            self.render_movement_highlights(
                valid_moves,
                current_position=current_entity_position
            )
        ...
        for entity in location.entities:
            self.render_entity(
                entity,
                draw_name=draw_entity_names,
                draw_hp_bar=draw_entity_hp_bars
            )
